...
bool vec_init(struct vec *vec, size_t dsize, size_t cap);
...
bool vec_resize(struct vec *vec, size_t cap);
bool vec_shrink(struct vec *vec);

bool vec_reserve(struct vec *vec, size_t index, size_t count);
